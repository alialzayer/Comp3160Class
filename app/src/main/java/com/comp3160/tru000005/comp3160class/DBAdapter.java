...
public class DBAdapter {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_TITLE, KEY_DESC, KEY_ACTION, KEY_DATE};
    ...
    public long insertRow(String title, String desc, String action, String date) {
		/*
		 * CHANGE 3:
		 */
    ...
    public boolean updateRow(long rowId, String title, String desc, String action, String date) {
        String where = KEY_ROWID + "=" + rowId;
